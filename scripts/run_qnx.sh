...
# If the caller didn't set IPCBENCH_BACKEND, default it.
# For PPS runs, do: IPCBENCH_BACKEND_DEFAULT=pps ./run_qnx.sh sender
IPCBENCH_BACKEND="${IPCBENCH_BACKEND:-${IPCBENCH_BACKEND_DEFAULT:-fastdds}}"
